...
import MercuryRifts.common.CreativeTabmr;
import MercuryRifts.network.CommonProxy;
import MercuryRifts.network.GuiHandler;
import MercuryRifts.network.PacketPipeline;
import MercuryRifts.portal.NetworkManager;

@Mod(name = MercuryRifts.NAME, modid = MercuryRifts.ID, version = "3.0.0", dependencies = MercuryRifts.DEPENDENCIES)
public class MercuryRifts
{
    public static final String NAME = "MercuryRifts", ID = "MercuryRifts", SHORT_ID = "mr", DEPENDENCIES = "after:ThermalExpansion", CLIENT_PROXY = "MercuryRifts.network.ClientProxy", COMMON_PROXY = "MercuryRifts.network.CommonProxy";
    public static final PacketPipeline packetPipeline = new PacketPipeline();
    public static final Logger logger = LogManager.getLogger("MercuryRifts");
    public static final CreativeTabs creativeTab = new CreativeTabmr();
    public static final String MODID_OPENCOMPUTERS = "OpenComputers", MODID_COMPUTERCRAFT = "ComputerCraft";

    @Instance(ID)
    public static MercuryRifts instance;
