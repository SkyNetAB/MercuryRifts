...
import mercuryrifts.client.gui.elements.BaseElement;
import mercuryrifts.client.gui.tabs.BaseTab;
import mercuryrifts.client.gui.tabs.TabTracker;
import mercuryrifts.inventory.BaseContainer;

public abstract class BaseGui extends GuiContainer
{
    RenderItem itemRenderer = new RenderItem();
    protected static final ResourceLocation playerInventoryTexture = new ResourceLocation("mercuryrifts", "textures/gui/player_inventory.png"), resizableInterfaceTexture = new ResourceLocation("mercuryrifts", "textures/gui/resizable_interace.png");
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        if (name != null)
        {
            getFontRenderer().drawString(mercuryrifts.localize(name), (xSize - mc.fontRenderer.getStringWidth(mercuryrifts.localize(name))) / 2, 6, 0x404040);
        }
