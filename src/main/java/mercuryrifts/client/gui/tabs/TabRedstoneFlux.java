...
public class TabRedstoneFlux extends BaseTab
{
    ...
    public void drawFullyOpened()
    {
        ...
        parent.getFontRenderer().drawStringWithShadow(mercuryrifts.localize("tab.redstoneFlux.maxPower"), posX + 10, posY + 20, 0xAAAAAA);
        parent.getFontRenderer().drawString(stabilizer.getEnergyStorage().getMaxEnergyStored() + " RF", posX + 17, posY + 32, 0x000000);

        parent.getFontRenderer().drawStringWithShadow(mercuryrifts.localize("tab.redstoneFlux.storedPower"), posX + 10, posY + 45, 0xAAAAAA);
        parent.getFontRenderer().drawString(stabilizer.getEnergyStorage().getEnergyStored() + " RF", posX + 17, posY + 57, 0x000000);
        
        parent.getFontRenderer().drawStringWithShadow(mercuryrifts.localize("tab.redstoneFlux.powerUsage"), posX + 10, posY + 70, 0xAAAAAA);
