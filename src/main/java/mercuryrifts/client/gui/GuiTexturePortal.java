...
import mercuryrifts.client.gui.elements.ElementFakeItemSlot;
import mercuryrifts.client.gui.elements.ElementScrollPortalIcons;
import mercuryrifts.client.gui.tabs.TabColour;
import mercuryrifts.client.gui.tabs.TabTip;
import mercuryrifts.client.gui.tabs.TabTipSecondary;
...
public class GuiTexturePortal extends BaseGui implements IFakeSlotHandler
{
    ...
    public GuiTexturePortal(TileController c, EntityPlayer p)
    {
        ...
        name = "gui.portal";
        texture = new ResourceLocation("mercuryrifts", "textures/gui/textures.png");
        leftNudge = 7;
    ...
    {
        String s = mercuryrifts.localize("gui.facade");
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        {
            mercuryrifts.packetPipeline.sendToServer(new PacketRequestGui(controller, GuiHandler.TEXTURE_C));
        }
    }
