...
public class GuiTransferItem extends BaseGui
{
    ...
    {
        super.initGui();
        buttonList.add(new GuiButton(1, guiLeft + 7, guiTop + 21, 140, 20, mercuryrifts.localize("gui." + (item.isSending ? "sending" : "receiving"))));
    }
    ...
    {
        super.updateScreen();
        ((GuiButton) buttonList.get(0)).displayString = mercuryrifts.localize("gui." + (item.isSending ? "sending" : "receiving"));
    }
}
