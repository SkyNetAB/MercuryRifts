...
public class GuiDiallingDeviceSave extends BaseGui
{
    ...
    public void initGui()
    {
        ...
        buttonList.add(new GuiButton(0, guiLeft + 7, guiTop + ySize - 27, 80, 20, mercuryrifts.localize("gui.cancel")));
        buttonList.add(new GuiButton(1, guiLeft + xSize - 87, guiTop + ySize - 27, 80, 20, mercuryrifts.localize("gui.save")));
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        getFontRenderer().drawString(mercuryrifts.localize("gui.uniqueIdentifier"), 7, 43, 0x404040);
        getFontRenderer().drawString(mercuryrifts.localize("gui.textures"), 7, 73, 0x404040);
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        {
            isEditing = true;
            mercuryrifts.packetPipeline.sendToServer(new PacketRequestGui(dial, GuiHandler.TEXTURE_DIALLING_SAVE_A));
        }
        else if (button.id == 101)
        {
            isEditing = true;
            mercuryrifts.packetPipeline.sendToServer(new PacketRequestGui(dial, GuiHandler.TEXTURE_DIALLING_SAVE_B));
        }
        else if (button.id == 102)
        {
            isEditing = true;
            mercuryrifts.packetPipeline.sendToServer(new PacketRequestGui(dial, GuiHandler.TEXTURE_DIALLING_SAVE_C));
        }
    }
}
