...
public class GuiTransferEnergy extends BaseGui
{
    ...
    {
        super.initGui();
        buttonList.add(new GuiButton(1, guiLeft + 7, guiTop + 29, 140, 20, mercuryrifts.localize("gui." + (energy.isSending ? "sending" : "receiving"))));
    ...
    {
        super.updateScreen();
        ((GuiButton) buttonList.get(0)).displayString = mercuryrifts.localize("gui." + (energy.isSending ? "sending" : "receiving"));
    }
}
