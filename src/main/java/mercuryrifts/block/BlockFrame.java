...
import mercuryrifts.tileentity.TileFrameTransfer;
...
import mercuryrifts.utility.ConnectedTexturesDetailed;

@InterfaceList(value = { @Interface(iface = "dan200.computercraft.api.peripheral.IPeripheralProvider", modid = mercuryrifts.MODID_COMPUTERCRAFT) })
public class BlockFrame extends BlockContainer implements IDismantleable, IPeripheralProvider
{
    ...
    public BlockFrame(String n)
    {
        ...
        connectedTextures = new ConnectedTexturesDetailed("mercuryrifts:frame/%s", this, -1);
    }
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        {
            overlayIcons[i] = register.registerIcon("mercuryrifts:frame_" + i);
            fullIcons[i] = register.registerIcon("mercuryrifts:frame_" + i + "b");
        }
        ...
        {
            mercuryrifts.logger.info("Registered custom frame Icon: " + String.format("%02d", counter) + ".png");
            ClientProxy.customFrameTextures.add(register.registerIcon("mercuryrifts:customFrame/" + String.format("%02d", counter)));
            counter++;
        }
    }
}
