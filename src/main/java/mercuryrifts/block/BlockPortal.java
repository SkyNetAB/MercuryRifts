...
public class BlockPortal extends BlockContainer
{
    ...
    {
        texture = iconRegister.registerIcon("mercuryrifts:portal");
        int counter = 0;
        ...
        {
            mercuryrifts.logger.info("Registered custom portal Icon: " + String.format("%02d", counter) + ".png");
            ClientProxy.customPortalTextures.add(iconRegister.registerIcon("mercuryrifts:customPortal/" + String.format("%02d", counter)));
            counter++;
        }
    }
